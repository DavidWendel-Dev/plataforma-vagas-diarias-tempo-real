...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="Conect Eventos">
    ...
    <nav class="navbar">
        <div class="container navbar-content">
            <a href="<?php echo url(); ?>" class="logo">
                <div class="logo-icon">
                    <img src="<?php echo url('assets/icons/icone.png?v=5'); ?>" alt="Conect Eventos" style="width:100%;height:100%;object-fit:contain;">
                </div>
