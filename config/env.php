...
define('APP_URL', Env::get('APP_URL', 'http://localhost/rapidjobs'));

define('DB_HOST', Env::get('DB_HOST', 'localhost'));
define('DB_NAME', Env::get('DB_NAME', 'rapidjobs_db'));
...
define('SESSION_NAME', Env::get('SESSION_NAME', 'rapidjobs_session'));
